        ...
        <main className="relative flex min-h-screen items-center justify-center overflow-hidden px-6 py-10">
            ...
            <div className="relative w-full max-w-md space-y-6">
                <div className="app-panel rounded-[2rem] p-6 text-center lg:text-left">
                    ...
                    <h1 className="mt-4 text-4xl font-black tracking-tight text-[#1d2430]">Welcome Back</h1>
                    <p className="mt-3 max-w-md text-sm text-[#6d5a48]">
                        Log in to continue tracking your habits, protect your streaks, and keep today&apos;s progress comfortably in view.
                    </p>
                </div>
